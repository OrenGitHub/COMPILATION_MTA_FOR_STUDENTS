...
#define MAX_NAME_LENGTH_OF_STRING_VAR 100
...
typedef enum
{
	...
	PSEUDO_MIPS_ASM_AST_VFTABLE_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_STRING_VAR_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_LOAD_REGISTERS_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_START_OF_CODE_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_ADD_IMMEDIATE_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_STORE_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_STORE_BYTE_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_LOAD_BYTE_EXP_TYPE,
	PSEUDO_MIPS_ASM_AST_LOAD_ADDRESS_EXP_TYPE,
	...
	PSEUDO_MIPS_ASM_AST_JUMP_AND_LINK_REG_EXP_TYPE,
...
typedef struct PSEUDO_MIPS_ASM_AST_LabelList_	*PSEUDO_MIPS_ASM_AST_LabelList;
...
struct PSEUDO_MIPS_ASM_AST_LabelList_
{
	char head[MAX_NAME_LENGTH_OF_LABEL];
	PSEUDO_MIPS_ASM_AST_LabelList tail;
};
...
struct PSEUDO_MIPS_ASM_AST_exp_
{
	...
	union
	{
		...
		char jump_and_link_reg[MAX_NAME_LENGTH_OF_LABEL];
		...
		struct {char name[MAX_NAME_LENGTH_OF_LABEL]; int serial_number;} jump_label;
 		...
 		struct {char var[MAX_NAME_LENGTH_OF_STRING_VAR]; char value[MAX_STRING_LENGTH];} string_var;
		...
		struct {char name[MAX_NAME_LENGTH_OF_LABEL]; PSEUDO_MIPS_ASM_AST_LabelList list;} vftable;

		struct {PSEUDO_MIPS_ASM_AST_Var var; int value;} load_immediate;
		struct {PSEUDO_MIPS_ASM_AST_Var var1; PSEUDO_MIPS_ASM_AST_Var var2;} load_byte;
		struct {PSEUDO_MIPS_ASM_AST_Var var1; char var2[MAX_NAME_LENGTH_OF_STRING_VAR];} load_address;
		...
		struct {PSEUDO_MIPS_ASM_AST_Var var1;PSEUDO_MIPS_ASM_AST_Var var2;} store_byte;
...
PSEUDO_MIPS_ASM_AST_exp PSEUDO_MIPS_STRING_VAR(char *var, char *value);
